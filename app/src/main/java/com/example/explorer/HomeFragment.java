...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        DirectoryFragView directoryFragView = new DirectoryFragView();
        switch (v.getId()) {
            case R.id.internal_storage_button:
                directoryFragView.setFile(Environment.getExternalStorageDirectory());
                break;
            case R.id.external_storage_button:
                directoryFragView.setFile(context.getExternalFilesDirs(null)[1]);
        }
        ((MainActivity) context).performFragTransaction(directoryFragView);
    }
